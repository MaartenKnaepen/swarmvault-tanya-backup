...
- Source material containing facts about Maarten or his projects
...
- Send raw conversation structure — never pre-summarise
...
- Use random UUIDs as document_id (causes duplicates)
