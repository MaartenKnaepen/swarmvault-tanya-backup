...
cssclasses:
  ...
  - sv-community
title: >-
  Community: Default to the inbox of whichever vault this script is deployed in
  module
tags:
  - graph
  - community
...
status: active
confidence: 1
created_at: '2026-08-13T00:07:58.534Z'
updated_at: '2026-08-13T00:07:58.534Z'
compiled_from:
  - default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3
managed_by: system
backlinks:
...
---
# Community: Default to the inbox of whichever vault this script is deployed in module

## Nodes

- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (module, degree=7, bridge=0)
- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (symbol, degree=6, bridge=0)
- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (symbol, degree=6, bridge=0)
- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (symbol, degree=6, bridge=0)
- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (symbol, degree=6, bridge=0)
- [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]] (symbol, degree=6, bridge=0)
