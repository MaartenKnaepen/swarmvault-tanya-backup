...
updated_at: '2026-07-12T02:00:44.656Z'
compiled_from:
...
- First-party: 6 sources, 50 pages, 56 nodes
...
| ----- | ------- | ----- | ----- | --------- | ------------ | ------------- | --------- |
| First-party | 6 | 50 | 56 | 14 | 5505 | 1831 | 66.7% |
...
- Default to the inbox of whichever vault this script is deployed in module API (form, extracted, 0.98). Default to the inbox of whichever vault this script is deployed in module and 6 defined symbols form one local module surface. Members: [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]], [[code/default-to-the-inbox-of-whichever-vault-this-script-is-deployed-in-f81e91f3|Default to the inbox of whichever vault this script is deployed in module]].
